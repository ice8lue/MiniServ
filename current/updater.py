...
if versio == onver:
	...
	if onver > versio:
		...
		print('\n  You should update!')
		WConio.textcolor(7)
		print('\n  This Updater can do all that for you, ok? [y/n]: ', end=" ")
		text = WConio.cgets(1)
		if text == 'n':
			exit()
		elif text == 'y':
			print('\n\n  Creating temp directory...', end=" ")
			goto_dir('temp')
			...
			print('\n  Killing running processes of Server / Console...', end =" ")
			serv = 0
			cons = 0
